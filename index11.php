...
<head>
    ...
    <title>3D Room with Promo</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .brand, .title, .subtitle, .cta-button {
            animation: fadeIn 0.8s ease-out forwards;
            opacity: 0;
        }

        .brand { animation-delay: 0.2s; }
        .title { animation-delay: 0.4s; }
...
<body>
    <div class="container">
        ...
        <div class="promo-section">
            <div class="brand">Falcon</div>
            <h1 class="title">Anunciamos falcon falcon</h1>
            <p class="subtitle">Impulsado por asndnhdd y la IA</p>
            <button class="cta-button">Conoce Más</button>
        </div>

        <!-- Sección de la habitación 3D -->
        <div class="room-section">
            <!-- Aquí va tu habitación 3D existente -->
    ...
    <script>
        ...
        let base = (x, y) => {
            var normalizedX = x / window.innerWidth - 0.5;
            var normalizedY = y / window.innerHeight - 0.5;
            h.style.transform = `
                perspective(90vw)
