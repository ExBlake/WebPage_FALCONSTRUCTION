<header>
    ...
    <div class="fullscreen-menu-header" id="fullscreenMenu">
        <div class="menu-content-header">
            <!-- Inicio de la sección de contenido del menú -->
            <div class="menu-icon-header" id="closeMenu" style="position: absolute; top: 45px; right: 64px;">
        ...
        <div class="menu-image-header"></div>
